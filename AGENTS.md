...
Single full-stack Netflix-style streaming app: Rust/Axum backend (port **5173**) + SolidJS/Vite MPA. SQLite at `cache/resolver-cache.sqlite`. No Docker in-repo. See `README.md` for architecture and API surface.
