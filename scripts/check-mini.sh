...
PUBLIC_URL="${PUBLIC_URL:-https://streamthatshit.com}"
PUBLIC_HOST="${PUBLIC_HOST:-streamthatshit.com}"
...
caddy_80=$(sudo lsof -nP -iTCP:80 -sTCP:LISTEN 2>/dev/null | awk 'NR == 2 {print $9}')
caddy_443=$(sudo lsof -nP -iTCP:443 -sTCP:LISTEN 2>/dev/null | awk 'NR == 2 {print $9}')
...
caddy_launch_state=$(launchctl print "system/com.fightingentropy.netflix-caddy" 2>/dev/null | awk -F= '/state =/ {gsub(/[ ";]/, "", $2); print $2; exit}')
app_runs=$(launchctl print "system/com.fightingentropy.netflix-app" 2>/dev/null | awk -F= '/runs =/ {gsub(/[ ";]/, "", $2); print $2; exit}')
caddy_runs=$(launchctl print "system/com.fightingentropy.netflix-caddy" 2>/dev/null | awk -F= '/runs =/ {gsub(/[ ";]/, "", $2); print $2; exit}')
